...
internal fun WireMockServer.stubOmsorgspengerJoarkHealth() = stubHealthEndpoint("$k9JoarkBaseUrl/health")

internal fun WireMockServer.getOmsorgspengerJoarkBaseUrl() = baseUrl() + k9JoarkBaseUrl
